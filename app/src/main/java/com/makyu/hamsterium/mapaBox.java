...
public class mapaBox extends AppCompatActivity {
    ...
    private final ActivityResultLauncher<String> activityResultLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
        ...
        public void onActivityResult(Boolean result) {
            if (result) {
                Toast.makeText(mapaBox.this, "¡Permiso autorizado! Reinicia la aplicación", Toast.LENGTH_SHORT).show();
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView = (MapView) findViewById(R.id.mapView);
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                if (ActivityCompat.checkSelfPermission(mapaBox.this, Manifest.permission.POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED) {
                    activityResultLauncher.launch(Manifest.permission.POST_NOTIFICATIONS);
                }
            };

            if (ActivityCompat.checkSelfPermission(mapaBox.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            && ActivityCompat.checkSelfPermission(mapaBox.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            setRoute.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(mapaBox.this,"Por favor seleccione una ubicación en el mapa", Toast.LENGTH_SHORT).show();
                }
            });
   ...
   private void fetchRoute(Point point){
        LocationEngine locationEngine = LocationEngineProvider.getBestLocationEngine(mapaBox.this);
        locationEngine.getLastLocation(new LocationEngineCallback<LocationEngineResult>() {
            ...
            public void onSuccess(LocationEngineResult result) {
                ...
                setRoute.setText("Buscando ruta...");
